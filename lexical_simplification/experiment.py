...
from lexical_simplification.labeler import SequenceLabeler
from lexical_simplification.evaluator import SequenceLabelingEvaluator
...
def process_sentences(data, labeler, is_training, learningrate, config, name):
    ...
    for sentence_ids_in_batch in batches_of_sentence_ids:
        ...
        # _ : predicted_probs
        cost, predicted_labels, _ = labeler.process_batch(batch, is_training, learningrate)
