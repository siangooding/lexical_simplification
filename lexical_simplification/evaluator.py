...
import collections
import numpy
import lexical_simplification.conlleval as conlleval
...
class SequenceLabelingEvaluator(object):
    ...
    def get_results(self, name):
        ...
        if self.label2id is not None and self.conll_eval == True:
            ...
            conll_metrics_overall, _ = conlleval.metrics(conll_counts)
...
#            for i, m in sorted(conll_metrics_by_type.items()): ==> conll_metrics_by_type = _ above
