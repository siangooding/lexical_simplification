...
def keywords(text, ratio=0.2, words=None, language="english", split=False, scores=False,
             deaccent=False, additional_stopwords=None, return_single_words_score=False):
    ...
    if return_single_words_score:  # access scores for all chosen single units in the sentence
        return keywords
...
if __name__ == '__main__':
    ...
    keywords = keywords(text, ratio=1, scores=True,
                        return_single_words_score=True)
    print(keywords)